...
class BasicBlockDownSample(BasicBlock):

    def __init__(self, inplanes, planes, downsample, stride=1):
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            ...
            layers.append(BasicBlockDownSample(
                self.inplanes, planes, downsample, stride))
        else:
