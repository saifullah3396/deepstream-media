...
def main():
    ...
    parser.add_argument(
        '--input_shape',
        help='Shape of the input to model [b,c,h,w].', required=True)
    ...
    try:
        ...
        print(
            "Unable to create shape from {} with error: {}. Please give input "
            "shape in correct format [b,c,w,h]".format(args.input_shape, exc))
        exit(1)
